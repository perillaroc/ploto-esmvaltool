...
def run_plotter(task: dict, work_dir: str, config: dict):
    ...
    task: dict
        a dict config of plotter task.
        {
            ...
            # generated by util.generate_script_settings
            "settings": {},
            "input_files": [
    ...
    settings = add_input_files(settings, input_files, work_dir)
...
def add_input_files(settings: dict, input_files: list, work_dir: str) -> dict:
    """
